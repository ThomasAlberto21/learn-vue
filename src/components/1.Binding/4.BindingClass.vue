<!-- Todo -->
<!-- Binding class di Vue.js adalah direktif yang digunakan untuk memasukkan nilai dari atribut class pada elemen HTML yang data nya diambil di komponen Vue -->
